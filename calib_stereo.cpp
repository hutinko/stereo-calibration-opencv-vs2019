...
static  vector< Point2f > corners1, corners2;
static  vector< vector< Point2f > > left_img_points, right_img_points;

static  Mat img1, img2, gray1, gray2;

void load_image_points(int board_width, int board_height, int num_imgs, float square_size,
	char* leftimg_dir, char* rightimg_dir, char* leftimg_filename,
	char* rightimg_filename, char* extension)
{
...
int calib_stereo_main(String img_dir = "./calib_imgs/1/", String out_file = "cam_stereo.yml")
{
	//int board_width = 9;
	//int board_height = 6;
	//int num_imgs = 27;
	...
	//./calibrate_stereo -n 27 -u cam_left.yml -v cam_right.yml -L ../calib_imgs/1/ 
	// -R ../calib_imgs/1/ -l left -r right -o cam_stereo.yml -e jpg

	//char* leftcalib_file;
	String leftcalib_file = "cam_left.yml";
	//char* rightcalib_file;
	String rightcalib_file = "cam_right.yml";
	const char* leftimg_dir = img_dir.c_str(); //"./calib_imgs/1/";
	const char* rightimg_dir = img_dir.c_str();// "./calib_imgs/1/";
